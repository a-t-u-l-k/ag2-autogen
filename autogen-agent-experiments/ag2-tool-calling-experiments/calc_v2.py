...
# Simple tool decorator to replace ag2.tool
def tool(func):
    @wraps(func)
...
class ArithmeticOllamaAgent:
    """An agent that performs arithmetic operations and processes queries with a local Ollama LLM."""
